...
//        System.out.println(str);
        ...
        String s = HttpRequest.sendGet("http://api.qingyunke.com/api.php", "key=free&appid=0&msg=" + str);
//        System.out.println(s);


        //发送 POST 请求
        String sr = HttpRequest.sendPost("http://api.qingyunke.com/api.php?key=free&appid=0&msg=hello", "");
